...
import cardsData from "@/constants/aboutPage/cards.json"; // Import JSON directly
      ...
      <div className="bg-indigo-800 min-h-screen">
        <div className="mx-auto w-[90%]">
          ...
          <p className="pt-7">
            ...
            most trusted brands. We offer advanced CCTV cameras, EPABX systems,
            and alarm systems to baggage scanners, biometric devices, and other
            smart security solutions for your complete security.
          </p>
          <p className="pt-7">Our strength lies in our four core pillars</p>
          <Image
