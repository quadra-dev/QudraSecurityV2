...
export default function RootLayout({
  ...
  return (
    <html lang="en">
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Quadra Security provides advanced security solutions including CCTV, surveillance, access control, and more.",
              sameAs: [
      ...
      <body
        className={`${inter.variable} overflow-x-hidden text-theme-white bg-gradient-to-b from-[#1d002e] via-[#2e0152] to-[#4b0082]`}
      >
        <NavigationBar />
        {children}
        <Footer />
